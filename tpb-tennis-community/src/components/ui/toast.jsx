...
export default function ToastView() {
    ...
    const addNotification = (type, title, message, showIcon, duration) => {
  ...
  return (
      <div className="relative min-h-screen p-4">
          ...
          <div
              className={`fixed p-4 space-y-2 w-full max-w-sm z-50 ${getPositionClasses(position)}`}>
            <AnimatePresence>
          ...
          <div
              className="mt-20 p-6 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-xl shadow-lg border border-gray-200/50 dark:border-gray-700/50">
            <h3
                className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4 text-center">Test Notifications</h3>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2">
                ...
                <button
                    onClick={() => addNotification(
                        'error',
                        'Critical Error!',
                        'This is a critical error that requires immediate attention. It will not auto-close.',
                        true
                    )}
                ...
                <button
                    onClick={() => addNotification(
                        'error',
                        'Connection Lost',
                        'Internet connection has been lost. Trying to reconnect...',
                        true,
                        8000
                    )}
                ...
                <button
                    onClick={() => addNotification(
                        'warning',
                        'Maintenance Mode',
                        'System will be under maintenance for 2 hours.',
                        false,
                        10000
                    )}
                ...
                <button
                    onClick={() => addNotification(
                        'info',
                        'Backup Started',
                        'Starting automatic backup process...',
                        false,
                        5000
                    )}
                ...
                <button
                    onClick={() => addNotification(
                        'success',
                        'Order Confirmed',
                        'Order #12345 has been confirmed and will ship soon.',
                        true,
                        5000
                    )}
                ...
                <button
                    onClick={() => addNotification(
                        'warning',
                        'Plugin Outdated',
                        'Some plugins need to be updated for security.',
                        true,
                        9000
                    )}
          ...
          {/* Position controls */}
          <div
              className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md p-3 rounded-xl shadow-lg flex flex-wrap justify-center gap-1 z-40 border border-gray-200/50 dark:border-gray-700/50">
              <button
