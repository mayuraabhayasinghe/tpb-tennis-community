  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="text-center">
        <div className="h-[600px] flex flex-col items-center justify-center bg-center bg-cover relative"
          style={{ backgroundImage: `url(${heroBg})` }}>
             <div className="absolute inset-0 bg-black/40"></div>
          <div className="text-white text-center z-10">
            <h1 className="font-bold text-3xl">Find Your Perfect Tennis Buddy</h1>
            <p className="mt-2">Connect with tennis players in your area, join games, or host your own matches.</p>
          </div>
        ...
        <div className="relative w-95 h-80 rounded-2xl overflow-hidden shadow-lg group  cursor-pointer" onClick={()=>{navigate("/games")}}>
          {/* Background image */}
          <img 
            src={Games} 
            alt="Game Requests" 
          ...
          <div className="absolute bottom-0 p-6 text-white z-10">
            ...
            <p className="mt-2 text-sm">Browse available games in your area or create your own and
                  invite others to join.</p>
          </div>
        </div>

      <div className="relative w-95 h-80 rounded-2xl overflow-hidden shadow-lg group cursor-pointer transform transition duration-300 hover:shadow-2xl hover:-translate-y-1" onClick={() => navigate("/requests")}>
          <img
            src={requests}
            alt="Game Requests"
            className="w-full h-full object-cover transform transition-transform duration-500 group-hover:scale-110"
          ...
          <div className="absolute bottom-0 p-6 text-white z-10">
            ...
            <p className="mt-2 text-sm">
              Send or respond to game requests from other players and find the perfect partner that matches your availability.
            </p>
          </div>
        </div>


      <div className="relative  w-95 h-80 rounded-2xl overflow-hidden shadow-lg group cursor-pointer"onClick={()=>{navigate("/rankings")}}>
          ...
          <div className="absolute bottom-0 p-6 text-white z-10">
            ...
            <p className="mt-2 text-sm">Enjoy your tennis match and rate your partners to help build
                a trusted community.</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col items-center justify-center text-center mt-10">
            ...
            <div className="m-5 grid grid-cols-1 md:grid-cols-2 gap-10 text-left">
                <div className="flex flex-row items-center gap-2">
                  ...
                  <div>
                    <h2 className="font-semibold text-lg">Find Players at Your Level</h2>
                    <p className="text-gray-600">
                      Our skill-matching system ensures you play with partners at your level.
                    </p>
                  </div>
                </div>  
            ...
            <div className="flex flex-row items-center gap-2">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Our rating system helps you find reliable and friendly tennis partners.
                </p>
              </div>
            </div>  
            ...
            <div className="flex flex-row items-center gap-2">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Verified profiles and secure messaging to ensure a safe experience.
                </p>
              </div>
            </div>
          </div>  
