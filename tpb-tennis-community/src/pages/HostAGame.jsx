  ...
  return (
    <>
      ...
      <div className="flex flex-col mt-20">
        <div className="bg-[#F8F9FA] w-full h-full min-h-screen flex justify-center items-center px-4 sm:px-6 md:px-0 pt-3.5">
          <div className="flex flex-col space-y-6">
            ...
            <div className="bg-[#FFFFFF] w-full max-w-[750px] min-h-[630px] flex flex-col items-center shadow-lg rounded-lg gap-2 p-6">
              ...
              >
                <div className="flex flex-col">
                  <label
                    htmlFor="court_name"
                    className="text-md mt-8 font-semibold"
                  >
                    Tennis Court Name
                  </label>
                ...
                <div className="flex flex-col md:flex-row gap-4 w-full">
                  <div className="flex flex-col w-full md:w-1/3">
                    ...
                    <div className="relative w-full mt-1">
                      ...
                      <input
                        ...
                        className="pl-10 border rounded-lg p-2 w-[220px]"
                        onChange={handleChange}
                        required
                      />
                    </div>
                  ...
                  <div className="flex flex-col w-full md:w-1/3 ">
                    ...
                    <div className="relative w-full mt-1">
                      ...
                      <input
                        ...
                        value={formData.game_start_time}
                        className="pl-10 border rounded-lg p-2 w-[220px]"
                        onChange={handleChange}
                        required
                      />
                  ...
                  <div className="flex flex-col w-full md:w-1/3 ">
                    <label htmlfor="endTime" className="text-md font-semibold">
                      End Time
                    </label>
                    <div className="relative w-full mt-1">
                      <MdAccessTime className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500 w-5 h-5 pointer-events-none" />
                  ...
                  <div className="flex flex-col w-full md:w-1/2">
                    ...
                    <div className="relative w-full mt-1">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="pl-10 border rounded-lg p-2 w-[350px]"
                      >
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="relative w-full mt-1">
                      ...
                      <textarea
                        ...
                        className="pl-10 border rounded-lg p-2 w-full h-[100px]"
                      ></textarea>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-end gap-4 w-full">
                  <button
                    type="button"
                    className="w-full md:w-[100px] h-[40px] border border-gray-400 text-gray-600 rounded-lg text-md font-semibold cursor-pointer"
                  ...
                  <button
                    type="submit"
                    className="w-full md:w-[150px] h-[40px] bg-green-500 text-white rounded-lg font-semibold cursor-pointer hover:bg-green-600 transition-colors duration-200"
                  >
                    Host Game
                  </button>
                </div>
            ...
            <div className="bg-[#FEFCE8] w-full max-w-[750px] border border-[#FEF08A] p-4 shadow-md rounded-lg mx-auto mb-6">
              ...
              <p className="text-lg text-[#946329]">
                After submitting this form, a unique reference number will be
                generated for your game. <br />
                If someone requests to join your game you will be notified about
                your game via SMS.
              </p>
            </div>
          </div>
